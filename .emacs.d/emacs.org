...
I wanted to include my snippet definition inside of this literate configuration, but the default behavious of both emacs & org to add a newline at the end of saved/tangled files messes with the snippets.
...
Probably the best & most performant traditional terminal emulation/experience you can get with Emacs. It's however non-trivial to install beyond just grabbing the package, thus I opt to install it outside of this configuration & call/configure the package only when it's available.
...
I think this is the best modern spell checker for emacs?
